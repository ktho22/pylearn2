...
words=['cat','dog','France','france','Canada','Paris','pars','brother','mother','sister','dad','mom','pharmacy','farm','quite','quiet','quit','like','love','city','town','into','Committee','?','first','must','his','$','including','well']
